...
BEGIN
    ...
    LOOP
        ...
        -- ASEGURAR que las justificadas tengan monto 0 por si acaso
        UPDATE eventos_nomina SET monto = 0 
        WHERE user_id = v_user_record.user_id 
          AND fecha_evento >= p_fecha_inicio AND fecha_evento <= p_fecha_fin
          AND tipo = 'FALTA' AND justificado IS TRUE;
        ...
        -- 3. Calcular Sumatoria de Deducciones (respetará el monto 0 de las justificadas)
